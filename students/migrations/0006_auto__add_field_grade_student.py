...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('students_grade', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='student', to=orm['students.Student']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grade.student'
        db.delete_column('students_grade', 'student_id')
