...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('students_student', 'comments', self.gf('django.db.models.fields.TextField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Student.comments'
        db.alter_column('students_student', 'comments', self.gf('django.db.models.fields.CharField')(max_length=300))
